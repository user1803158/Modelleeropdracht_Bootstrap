...
BCa <- function(bootstrap_estimates, bootstrap_sderrors, theta_hat, start_sample, sample_sderror, theta_estimator, alpha) {
...
intervals <- function(bootstrap_estimates, bootstrap_sderrors, theta_hat, start_sample, sample_sderror, theta_estimator, alpha){
  list(
    BCa(bootstrap_estimates, bootstrap_sderrors, theta_hat, start_sample, sample_sderror, theta_estimator, alpha),
