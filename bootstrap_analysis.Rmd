...
for (n in c(10, 50, 200, 1000)){
  param_tests = append(param_tests, list(
    list(
      ...
      T_estimator=norm_mean_estimator, 
      n=n
    ),
    list(
    ...
    list(
      ...
      T_estimator=cauchy_loc_estimator, 
      n=n
    ),
    list(
      ...
      T_estimator=exponential_estimator, 
      n=n
    ),
    list(
...
for (x in param_tests){
  ...
  monster_results = param_monster(x$true_distr_gen, x$true_params, x$true_T, x$full_estimator, x$n, M, N, true_variance_N, alphas,
                                  x$T_estimator, x$fake_distr_gen)
...
for (x in nonparam_tests){
  ...
  print(paste("calculating ", full_name, "...", sep=""))
  monster_results = nonparam_monster(x$true_distr, x$T_estimator, x$true_T, x$n, M, N, true_variance_N, alphas)
  results_list <- append(results_list, list(append(list(test=full_name), monster_results)))
}
