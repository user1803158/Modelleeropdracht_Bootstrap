...
niceplot <- function(results, title){
...
results = param_monster(true_distr_gen=mean0norm, true_params=true_param, params_estimator=function(x) sd(x), n=100, N=1000, M=300, true_variance_N=10000, true_theta=true_param, alphas=c(0.01, 0.05))
...
results = param_monster(true_distr_gen=normdist, true_params=true_params, params_estimator=full_estimator, estimator=estimator, n=100, N=1000, M=300, true_variance_N=10000, true_theta=true_params$sd)
